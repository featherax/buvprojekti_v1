(function(){
  ...
  const SECTIONS = [
    ...
    },
    {
      ...
      href:'https://architecturevivente.com/',
    ...
    },
    {
      ...
      href:'https://sacredgeometrysites.com/',
      bg:'https://sacredgeometrysites.com/wp-content/uploads/2024/12/B-W-29-scaled.jpg'
    }
  ];
  ...
  list.innerHTML = SECTIONS.map((s,i)=>`
    <div class="vs-panel" data-i="${i}">
      ...
      <div class="vs-details">
        ...
        <a class="vs-btn" href="${s.href}">Uzzināt vairāk</a>
      </div>
    </div>
  `).join('');
